...
# Memory: descriptor_memory0
MEM_0 := nios_system_descriptor_memory0
$(MEM_0)_NAME := descriptor_memory0
...
$(MEM_0)_START := 0x00101000
$(MEM_0)_END := 0x00101fff
$(MEM_0)_SPAN := 0x00001000
$(MEM_0)_HIERARCHICAL_PATH := descriptor_memory0
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: descriptor_memory0
descriptor_memory0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: descriptor_memory1
MEM_1 := nios_system_descriptor_memory1
$(MEM_1)_NAME := descriptor_memory1
...
$(MEM_1)_HIERARCHICAL_PATH := descriptor_memory1
$(MEM_1)_WIDTH := 32
$(MEM_1)_HEX_DATA_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: descriptor_memory1
descriptor_memory1: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

# Memory: main_memory
MEM_2 := nios_system_main_memory
$(MEM_2)_NAME := main_memory
...
$(MEM_2)_END := 0x000cafff
$(MEM_2)_SPAN := 0x0004b000
$(MEM_2)_HIERARCHICAL_PATH := main_memory
$(MEM_2)_WIDTH := 32
...
.PHONY: main_memory
main_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
